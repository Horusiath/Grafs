...
and GQLInfo = 
    ...
    member this.GetPath (keys: string list) : GQLInfo option =         
...
and ExecuteField = ResolveFieldContext -> obj -> Grafs.AsyncVal<obj>
