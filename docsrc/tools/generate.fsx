...
let githubLink = "https://github.com/fsprojects/Grafs"

// Specify more information about your project
let info =
  [ "project-name", "Grafs"
    "project-author", "Bazinga Technologies Inc."
    "project-summary", "A F# implementation of GraphQL language for server and client"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Grafs" ]
